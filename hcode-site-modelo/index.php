...
<html lang="pt-br">
  <head>
    ...
    <?php 
        define("SITE", "http://localhost/site");
        define("ASSETS", "http://localhost/site/assets");
    ?>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="<?php echo ASSETS ?>/img/logo.png"></a></h1>
                    </div>
                </div>
                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo ASSETS ?>/img/product-1.jpg" alt="">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo ASSETS ?>/img/product-2.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo ASSETS ?>/img/product-3.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo ASSETS ?>/img/product-4.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo ASSETS ?>/img/product-5.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo ASSETS ?>/img/product-6.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
