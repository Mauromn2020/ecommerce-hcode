    ...
    <!-- jQuery easing -->
    <script src="<?php echo ASSETS ?>/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="<?php echo ASSETS ?>/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="<?php echo ASSETS ?>/js/bxslider.min.js"></script>
	<script type="text/javascript" src="<?php echo ASSETS ?>/js/script.slider.js"></script>
  </body>
</html>